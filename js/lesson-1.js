...
// alert("Вітаємо!"); //цей метод не потрібно виводити в консоль або повертати змінну, він видасть undefined

// const login = prompt("Введіть логін"); //повертає рядок або null
// console.log(login);

// const isAdult = confirm("Чи є вам 18 років?"); // повертає true або false
// console.log(isAdult);
...
//   //     return a;
//   //   }
//   //   return Math.min(a, b); // інший метод
//   return a > b ? b : a;// ще один метод
// }
